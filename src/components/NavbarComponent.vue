  ...
  <div class="bg-white isolate">
    ...
    <div class="px-6 pt-6 lg:px-8">
      <nav class="flex items-center justify-between" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="inline h-10" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
          </a>
        </div>
      ...
      <Dialog as="div" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
        <DialogPanel
          focus="true"
          class="fixed inset-0 z-10 px-6 py-6 overflow-y-auto bg-white lg:hidden"
        >
...
export default {
    components : {Dialog,DialogPanel, Bars3Icon, XMarkIcon, ButtonComponent, },
